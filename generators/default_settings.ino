...
#define DRIVER_CONTROLS_DELAY_BEFOR_LONG_PRESS 50
...
#define EVENT_ON_TOUCH_DOUBLE_PRESS         0x0B
...
#define CONTROLS_DELAY_TO_DOUBLE_CLICK_MS DRIVER_CONTROLS_DELAY_BEFOR_LONG_PRESS
